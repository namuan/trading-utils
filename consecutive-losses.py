...
def main():
    ...
    max_consecutive_lower_close, consecutive_lower_close_periods = find_max_consecutive_lower_closes(df)
    max_percentage_drop = calculate_max_percentage_drop(df, consecutive_lower_close_periods)
    ...
    max_consecutive_lower_close_weekly, consecutive_lower_close_periods_weekly = find_max_consecutive_lower_closes(df_weekly)
    max_percentage_drop_weekly = calculate_max_percentage_drop(df, consecutive_lower_close_periods_weekly)
    ...
    print("Max Percentage Drop in Consecutive Weekly Lower Closes:", max_percentage_drop_weekly)
