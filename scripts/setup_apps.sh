...
bash ./scripts/start_screen.sh strat-usdt 'python3 crypto_strat_bot.py --strategy strat --buying-budget 10 --coins ADA,XLM,MATIC,DOGE --stable-coin USDT --time-frame 5m'
